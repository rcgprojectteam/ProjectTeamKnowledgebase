...
4. Grant: Select 'Grant Access' then select 'Require multifactor authentication.'
5. Save your policy. (Policy can take 15+ minutes to populate.)
6. Verify MFA is disabled for the migration@clientdomain.com user account via the Office365 admin center and test migration account login to Office 365. 