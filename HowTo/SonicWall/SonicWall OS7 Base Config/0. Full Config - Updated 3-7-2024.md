...
firewall
    ...
    exit
commit
#--- control plane commands may need to be control-plane-flood-protection and control-plane-flood-protection-threshold 80---------------------------------------------------------------
snmp
    enable
    system-name "name"
    ...
    exit
commit
#--- log name resolution command may need to be log name-resolution ----------------------------------------------------------------------------------------------------------------
log name_resolution
   method dns
   dns inherit   
exit
...
content-filter
    ...
    exit
commit
#----------------------------------------SonicWall must be registered in MySonicWall for this section to work-------------------------------------------------------------------------------------------------------------------------------------------------
content-filter
    filter-type cfs
    cfs
        enable
